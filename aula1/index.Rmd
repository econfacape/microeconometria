...
Relacionado mas conceitualmente muito diferente é a análise da regressão e de correlação. Na correlação o objetivo é mensurar o grau de associação linear entre duas variáveis. 
...
![Correlação Positiva e Negativa](img_r/aporho1.png){width=85%}
...
Na regressão é estimar ou prever o valor médio do regressando (Y) com base nos valores fixos dos regressores (X).
